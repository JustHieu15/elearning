            ...
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 mb-2 bg-gray-700">
                ...
                <form action="{{ route('admin.user.update') }}"
                    ...
                    <div class="flex w-full justify-between items-center mt-5">
                        <!-- Class ID -->
                        <h2 class="text-white text-base font-semibold">User ID (Auto generated)</h2>
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                ...
                                <input id="npm-install-copy-button" type="text"
                                       ...
                                       value="USER {{ $user->id }}" disabled readonly>
                    ...
                    <div class="flex w-full justify-between items-center mt-3">
                        <h2 class="text-white text-base font-semibold">Name</h2>
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <input type="text" id="class_name" value="{{ $user->name }}" disabled
                    ...
                    <div class="flex w-full justify-between items-center mt-3 ">
                        <h2 class="text-white text-base font-semibold">Change Role</h2>

                        <div class="flex flex-row text-white">
                            <label for="role" class="sr-only">Change Role</label>
