    ...
    <div class="p-4 sm:ml-auto mr-auto max-w-4xl">
        ...
        <div class="p-2">
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 bg-gray-700">
                <h1 class="text-white text-xl font-bold">Create your new semester</h1>

                <form action="{{ route('admin.semester.store') }}" class="flex flex-col w-full h-auto items-center"
                      method="POST">
                    @csrf
                    ...
                    <div class="flex w-full justify-between items-center mt-3">
                        ...
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <input type="date" id="class_name" name="start_date"
                    ...
                    <div class="flex w-full justify-between items-center mt-3">
                        ...
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <input type="date" id="class_name" name="end_date"
                                       class="col-span-6 bg-gray-700 border text-white text-sm rounded-lg block w-full p-2.5"
                                       placeholder="DD/MM/YYYY"/>
                            </div>
                        </div>
