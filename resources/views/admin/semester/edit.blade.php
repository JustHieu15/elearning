    ...
    <div class="p-4 sm:ml-auto mr-auto max-w-4xl">
        <div class="p-2">
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 mb-2 bg-gray-700">
                <h1 class="text-white text-xl font-bold">Edit your semester</h1>

                <form action="{{ route('admin.semester.update') }}"
                    ...
                    <div class="flex w-full justify-between items-center mt-5">
                        <!-- Class ID -->
                        <h2 class="text-white text-base font-semibold">Your Semester ID (Auto generated)</h2>
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                ...
                                <input id="npm-install-copy-button" type="text"
                                       ...
                                       value="SEMESTER {{ $schoolYear->id }}" disabled readonly>
                    ...
                    <div class="flex w-full justify-between items-center mt-3">
                        <h2 class="text-white text-base font-semibold">Insert start date</h2>
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <input type="date" id="class_name" name="start_date" value="{{ $schoolYear->start_date }}"
                    ...
                    <div class="flex w-full justify-between items-center mt-3">
                        <h2 class="text-white text-base font-semibold">Insert end date</h2>
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <input type="date" id="class_name" name="end_date" value="{{ $schoolYear->end_date }}"
                                       class="col-span-6 bg-gray-700 border text-white text-sm rounded-lg block w-full p-2.5"
                                       placeholder="DD/MM/YYYY"/>
                            </div>
                        </div>
