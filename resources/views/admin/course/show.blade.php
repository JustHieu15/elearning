    ...
    <div class="p-4 sm:ml-auto mr-auto max-w-4xl">
        <div class="p-2">
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 mb-2 bg-gray-700">
                <h1 class="text-white text-xl font-bold">Show your course</h1>
                        ...
                        @foreach ($tests as $index => $test)
                            <tr class="odd:bg-gray-700 even:bg-gray-400">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @php $time = explode(':', $test->time_limit) @endphp
                                    {{ $time[0] * 60 + $time[1] }} minutes
                                </td>

                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('admin.test.show', $test->slug) }}" class="font-medium text-orange-500 hover:underline">Show</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
