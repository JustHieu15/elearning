    ...
    <div class="p-4 sm:ml-auto mr-auto max-w-4xl">
        <div class="p-2">
            <div class="flex flex-col w-full h-auto items-center rounded-lg p-4 mb-2 bg-gray-700">
                ...
                <form action="{{ route('admin.collection.update', $collection->slug) }}" class="flex flex-col w-full h-auto items-center"
                      method="POST">
                    @method('PATCH')
                    @csrf
                        ...
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                ...
                                <input id="npm-install-copy-button" type="text"
                                       ...
                                       value="COURSE {{ $collection->id }}" disabled readonly>
                        ...
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <input type="text" id="class_name" name="name"
                                       ...
                                       placeholder="Ex: Unit 1" value="{{ $collection->name }}"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="w-full max-w-[16rem]">
                            <div class="relative">
                                <select id="subject" name="subject_id" disabled
                                        class="bg-gray-700 border text-white text-sm rounded-lg block w-64 p-2.5">
                                    <option value="{{ $collection->subject_id }}">{{ $collection->subject_name }}</option>
                                </select>
                            </div>
                        </div>
                    </div>
