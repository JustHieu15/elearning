    ...
    <div class="p-4 sm:ml-auto mr-auto max-w-4xl">
        <div class="p-2">
            <div class="flex w-full h-auto justify-between items-center rounded-lg p-4 bg-gray-700">
                <h2 class="text-white text-base font-semibold">Create a new Collection</h2>
        ...
        <div class="p-2">
            <div class="w-full h-auto rounded-t-lg p-4 bg-gray-700">
                <h1 class="text-white text-3xl font-bold mb-2 uppercase text-center">
                    Welcome to EduZone's Collection!
                </h1>
            </div>

            <div class="flex w-full h-auto justify-between items-center rounded-b-lg p-4 bg-gray-700">
                <h2 class="text-white text-base font-semibold">Choose session</h2>
                <div>
                    <form class="max-w-xl mx-auto">
                        <div class="flex flex-row text-white">
                            <!-- Choose subject -->
                            <label for="subject" class="sr-only">Choose subject</label>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-white">
                    ...
                    @foreach($collections as $key => $collection)
                        <tr class="odd:bg-gray-700 even:bg-gray-400">
                            ...
                            <td class="px-6 py-4 text-center">
                                {{ $collectionQuestion->where('collection_id', $collection->id)->count()}}
                            </td>

                            <td class="px-6 py-4 text-center">
                                <a href="{{ route('admin.collection.add-question', $collection->slug) }}"
                                   class="font-medium text-orange-500 hover:underline me-3">
                                    Add Question
                                </a>

                                <a href="{{ route('admin.collection.edit', $collection->slug) }}"
